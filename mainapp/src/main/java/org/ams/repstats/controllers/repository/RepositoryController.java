...
public class RepositoryController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RepositoryController.class); ///< ссылка на логер
    ...
    public void repositoryResponsibleButtonAction() {
        try {
            ...
            loader.setLocation(getClass().getClassLoader().getResource("view/repository/repositoryResponsibleSelectView.fxml"));
